        ...
        <AlertDialog.Content className="fadeIn fixed left-[50%] top-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-[#2c2c2c] p-[25px]">
          ...
          <div className="flex justify-end gap-[25px]">
            <AlertDialog.Cancel asChild>
              <button className="inline-flex h-[35px] items-center justify-center rounded-[4px] bg-dialogButton px-[15px] text-white transition-all hover:bg-dialogInput">Cancel</button>
            </AlertDialog.Cancel>
